"""
shapenetpart_full.py — Full ASP-SNN run on ShapeNetPart
...
def _find_proj_root(sentinel="train_shapenet.py"):
    ...
    if not os.path.isdir(clone_dir):
        ...
        subprocess.run([
            "git", "clone", "--depth=1",
            "https://github.com/ayush31010/ASP-SNN.git", clone_dir,
        ], check=True)
